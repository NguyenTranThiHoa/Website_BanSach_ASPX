<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ChucMungDatHang.aspx.cs" Inherits="QuanLySach.ChucMungDatHang" %>
...
<!----------------------------------------------------------------------------------------------> 
        <h1 style="text-align: center; margin-top: 50px; color:#D3C734"> Cảm ơn quý khách đã mua hàng. <br/>
        Chúng tôi sẽ sớm duyệt và giao đơn hàng sớm nhất cho bạn. </h1>
<!------------------------------------Footer----------------------------------------------------> 
            <style>
            /*---------------video----------------*/
            .video{
