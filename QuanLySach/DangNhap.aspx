<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DangNhap.aspx.cs" Inherits="QuanLySach.DangNhap" %>
...
<article>
    <div class="dangnhap1">
        ...
        <asp:TextBox ID="txtUsername" runat="server" placeholder="Email or phone number"></asp:TextBox>
        ...
        <h4>
            ...
            <a href="DangKy.aspx" style="color: blue">Register here</a>
        </h4>
