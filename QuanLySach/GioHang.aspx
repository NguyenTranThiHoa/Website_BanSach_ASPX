<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GioHang.aspx.cs" Inherits="QuanLySach.GioHang" %>
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12">
                        <div class="checkout_order">
                                    ...
                                    <tr>
                                        ...
                                        <td></td>
                                         <td></td>
                                            <td>
                                                <div class="capnhat">
                                                    <button type="submit" class="btn btn-warning" name="update" id="update_btn_">Cập nhật</button>
                                                </div>
                                            </td>
                                        <td>
                                            <div class="xoa">
                            ...
                            <div class="checkout_order_total">Tổng tiền: <span id="totalAmountSpan" runat="server"></span></div>
                            <div class="buttons">
                                <a href="checkout.aspx" class="btn btn-success" onclick="return redirectToCheckout();">Thanh toán</a>
                            </div>
