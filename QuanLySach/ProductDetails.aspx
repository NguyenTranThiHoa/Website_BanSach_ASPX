<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProductDetails.aspx.cs" Inherits="QuanLySach.ProductDetails" %>
...
<head runat="server">
    ...
    <link rel="stylesheet" href="DangNhap.aspx" type="text/html">
    <link rel="stylesheet" href="CSS/banhang.css" type="text/css">
...
<body style="background-color:white;">
    <form id="form1" runat="server">
        ...
        <!--Chi tiết sản phẩm-->
<%--    <article>
        <asp:Literal ID="productDetailsLiteral" runat="server">
        </asp:Literal>   
    </article>--%>

           <!--Chi tiết sản phẩm-->
                 <article>
                    <div class='flex-box' runat="server" id="pnlProductDetails" visible="false">
                        <div class='left'>
                            <div class='big-img'>
                        ...
                        <div class='right' style="margin-left: 30px">
                            <div class='pname' id="lblProductName" runat="server"></div>
                            <div class='pname1' id="lblProductCode" runat="server"></div>
                            <br>
                            <div class='pname2' id="lblProductDescription" runat="server"></div>
                            <div class='price' style='color: rgba(0, 106, 255, 0.759);' id="lblProductPrice" runat="server"></div>
                            <div class='form-container'>
                                <div id='addToCartForm' runat='server'>
                                    <input type='hidden' id='productIdField' runat="server" />
                                    <div class='quantity'>
                                        <p>Số lượng :</p>
                                        <asp:TextBox ID="qty" runat="server" Text="1" />
                                    </div>
                                    <div class='btn-box'>
                                        <asp:Button ID='addToCartButton' runat='server' Text='Thêm vào giỏ hàng' OnClick='AddToCart_Click' BackColor="#66FF66" BorderColor="#33CCFF" ForeColor="#0066FF" Height="40px" Width="250px"/>
                                    </div>
                                </div>
                            </div>
                        </div>
