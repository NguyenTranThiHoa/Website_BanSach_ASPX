<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ChiTietSanPham.aspx.cs" Inherits="QuanLySach.ChiTietSanPham" %>
    ...
    <!-------------------------------------------------------------------------------------------------------->
        <footer>
            ...
            <div class="footer-top">
                ...
                <div class="hinhanh">
                    <img src="IMAGE/THIHOA.png" alt="Logo" width="130" height="80">
                </div>
            </div>
        </footer>
    </form>
