<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Category.aspx.cs" Inherits="QuanLySach.DanhMucSanPham.Category" %>
...
<head runat="server">
      ...
      <link rel="stylesheet" href="CSS/PhanLoaiSanPham.css" type="text/css">
    ...
    <form id="form1" runat="server">
        ...
        <section>
            <div class="slideshow-container">
                <img src="IMAGE/nen.jpg" style="width:100%">
            </div>
            <br>
        </section>
<!------------------------------------------------------------------------> 
